...
7.   Small effect size of 0.2, if this were a real study you could base this off effect sizes from meta analyses etc.
...
10. Calculate effect size for independent t test where *t = 4.25*.
    ...
    # for N do we use real N or calculated hypothetical group sizes??
    #code below uses N from data set for superpower yes/no
    n1 <- 780 #group size from last question -
    n2 <- 32 # group 2 size """"
